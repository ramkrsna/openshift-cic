...
if choice == 1:
        ...
        if avail_hosts == 4:
                ...
                totalcalc = int (registry_pvsize + (50/100.0) * registry_pvsize )
                if totalcalc > cluster_storage :
                        ...
                        print "+registry PV + 50% < sum of storage devices per node \033[0m"
                        exit() 
        ...
        if avail_hosts == 7:
                ...
                cluster_storage = len(raw_devices) * raw_storage_size * len(app_hosts)
                calc_gfs = block_host_size + registry_pvsize 
                totalcalc = int (calc_gfs + (50/100.0) * calc_gfs )
                if totalcalc < cluster_storage :
                        print "cluster_storage=%d" % cluster_storage
                        print "totalstoragecalc=%d" % totalcalc 
                        print "\033[91m Total Storage is Oversubscribed \033[0m"
        ...
        if avail_hosts == 7:
                ...
                print "[glusterfs_registry]"
                print  met_hosts[0] + " glusterfs_devices=" + "'" + json.dumps(met_devices) + "'"
                print  met_hosts[1] + " glusterfs_devices=" + "'" + json.dumps(met_devices) + "'"
                print  met_hosts[2] + " glusterfs_devices=" + "'" + json.dumps(met_devices) + "'"
                print " "
                ...
                if totalcalc < cluster_storage :
                        ...
                        print "\033[91m Total Storage is Oversubscribed \033[0m"
                        print "\033[91m Please provision the storage \033[0m" 
                        print "\033[91m Total storage calc = block_host_vol_size (if it exists) \033[0m"
                        print "\033[91m + registry PV < sum of storage devices per node \033[0m"
                        exit()
        ...
        if avail_hosts == 7:
                ...
                print "[glusterfs_registry]"
                print  met_log_hosts[0] + " glusterfs_devices=" + "'" + json.dumps(met_log_devices) + "'"
                print  met_log_hosts[1] + " glusterfs_devices=" + "'" + json.dumps(met_log_devices) + "'"
                print  met_log_hosts[2] + " glusterfs_devices=" + "'" + json.dumps(met_log_devices) + "'"
                print "   "
        ...
        if avail_hosts == 4:
                ...
                #cluster_storage = int(len(raw_devices)) * raw_storage_size * len(app_hosts)
